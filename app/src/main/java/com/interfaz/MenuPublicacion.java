...
import com.logica.Validaciones.Validaciones;

import java.io.IOException;

public class MenuPublicacion extends AppCompatActivity {
    //variable para almacenar la direccion de la imagen en el telefono
    static private String URIFoto="/data/data/com.example.menuprincipal/files/img/product-category-icon-5.jpg";
    ...
    public void siguienteActivity(View v) {
        if (validar()) alerta("Producto creado exitosamente.");
            ...
            if (((EditText)findViewById(R.id.editTextNumber)).getText().toString().isEmpty()){
                ((EditText)findViewById(R.id.editTextNumber)).setText("Can");
            }
            if (((EditText)findViewById(R.id.editTextNumberDecimal)).getText().toString().isEmpty()){
                ((EditText)findViewById(R.id.editTextNumberDecimal)).setText("Precio");
            }}
    ...
    private void toasts(){
        ...
        //cantidad
        if (!flagCant) Toast.makeText(com.interfaz.MenuPublicacion.this,"Cantidad debe ser entre 1 y 999 y sólo debe contener dígitos",Toast.LENGTH_SHORT).show();
        //precio
        if (!flagPrecio) Toast.makeText(com.interfaz.MenuPublicacion.this,"Precio debe ser entre 1 y 999 y sólo debe contener dígitos y punto",Toast.LENGTH_SHORT).show();
        //descripcion
        if (!flagDesc) Toast.makeText(com.interfaz.MenuPublicacion.this,"Descripción debe tener entre 20 y 280 caracteres",Toast.LENGTH_LONG).show();
        //nombre
        if (!flagNombre) Toast.makeText(com.interfaz.MenuPublicacion.this,"Nombre debe tener entre 5 y 50 caracteres",Toast.LENGTH_LONG).show();
    ...
    public void alerta(String mensaje){
        AlertDialog.Builder builder = new AlertDialog.Builder(com.interfaz.MenuPublicacion.this);
       ...
       resize(Uri.parse(URIFoto),findViewById(R.id.imageView2));
        ...
        findViewById(android.R.id.content).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                esconderTeclado(com.interfaz.MenuPublicacion.this);
                return false;
            }
        });
        }
